...
end tankbatt_ebaz4205;
------------------------------------------------------------------------------
architecture struct of tankbatt_ebaz4205 is
 ...
 --
 signal video_r         : std_logic;--_vector(7 downto 0);
 signal video_g         : std_logic;--_vector(7 downto 0);
 signal video_b         : std_logic;--_vector(7 downto 0);
 --
 ...
 --signal audio_r         : std_logic_vector(5 downto 0);
...
control <= '1' & '1' & not SW_COIN & not P2_START & not P1_START & not SW_FIRE & not SW_UP & not SW_DOWN & not SW_LEFT & not SW_RIGHT;

-- / service / test / coin / start 2p / start 1p / shoot / up / down / left / right / --
---------------------------------------------------------------------------
-- Main

pm : entity work.Tankb_fpga
port map (
CLK_18M  => clock_18,
--CLK_6M  => clock_6,
RED      => video_r,
...
RESET_n  => I_RESET,
CONTROLS => control,
DIP      => "11001111", -- / NA / TEST / LIVES / BONUS / BONUS / COIN / COIN / CAB /
AUDIO_L  => audio_l,
--AUDIO_R  => audio_r,
AD       => AD
);
-----------------------------------------------------------------
video_r_i <= video_r & video_r & video_r & video_r & video_r & video_r when h_blank = '0' and v_blank = '0' else "000000";
video_g_i <= video_g & video_g & video_g & video_g & video_g & video_g when h_blank = '0' and v_blank = '0' else "000000";
video_b_i <= video_b & video_b & video_b & video_b & video_b & video_b when h_blank = '0' and v_blank = '0' else "000000";
-----------------------------------------------------------------
-- scan doubler
